...
# Importing company's ticker and country's necessary information
from Company_and_Country import company_ticker, equity_risk_premium, bond_yield, country_risk_premium
...
cost_equity = bond_yield + country_risk_premium + levered_beta * equity_risk_premium

# Calculating the cost of debt
cost_debt = bond_yield + country_risk_premium + company_default_spread
